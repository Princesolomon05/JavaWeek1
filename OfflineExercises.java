...
public class OfflineExercises {
	...
	public ArrayList<String> word(String morse) {
		ArrayList<String>words = new ArrayList<String>();
		
	public String getSandwich(String input) {
		String = jam;
		while (getSandwich.contains(" / ")) {
			
			int a = getSandwich.indexOf(" / ");

			words.add(getSandwich.substring(0, a));
			a = getSandwich.substring(a+2,morse.length());
		return "jam";
	}
